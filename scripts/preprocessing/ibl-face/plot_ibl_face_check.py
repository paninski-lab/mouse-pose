#!/usr/bin/env python3
"""
Write annotated check images for the ibl dataset.

Reads CollectedData.csv / CollectedData_test.csv from _raw/ibl/ and
...
CHECK_DIR = IBL_DIR / "labeled-data-check"
